...
-- Question 8: Write an SQL query to list all employee names along with their total number of reviews.                                                            

-- Anster to the Question No. 08:
...
-- This is the main part of the code which counts the number of distinct review dates.
SELECT e.employee_name, COUNT(pr.review_id) AS total_reviews
FROM employees e
