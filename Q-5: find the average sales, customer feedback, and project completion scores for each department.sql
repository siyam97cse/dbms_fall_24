...
-- Question 5: Write an SQL query to find the average sales, customer feedback, and project completion scores for each department.

-- Anster to the Question No. 05:
...
-- This is the main part of the code which finds the average sales, customer feedback, and project completion scores for each department
