...
-- Question 3: Write an SQL query to find the highest customer feedback score received by any employee.
...
-- This is the main part of the code which finds the highest customer feedback score received by any employee.
