...
-- Question 2: Write an SQL query to calculate the average sales performance score of all employees.
...
-- This is the main part of the code which calculates the average sales performance score of all employees.
SELECT AVG(sales_performance_score) AS avg_sales_score
