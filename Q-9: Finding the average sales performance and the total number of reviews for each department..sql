...
-- Question 9: Write an SQL query to find the average sales performance and the total number of reviews for each department.                                                                                
  
-- Anster to the Question No. 09:
...
-- This is the main part of the code which finds the average sales performance and the total number of reviews for each department.
